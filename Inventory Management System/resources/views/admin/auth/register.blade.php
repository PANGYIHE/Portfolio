<x-guest-layout>
    <form method="POST" action="{{ route('admin.register') }}">
        ...
        <h2 class="text-center mb-3 text-gray-600 dark:text-gray-400">Retailer Register</h2>
        <!-- Name -->
        <div>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="license" class="block mt-1 w-full" type="text" name="license" :value="old('license')" required autocomplete="license" />
