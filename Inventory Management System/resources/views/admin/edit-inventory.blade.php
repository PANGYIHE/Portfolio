            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="container p-4">
                    <div class="card">
                        ...
                        @endif
                        <div class="card-body">
                        <form action="{{ route('admin.EditInventory') }}" method="post">
                                @csrf
                                <input type="hidden" name="inventory_id" value="{{$inventory->id}}">
                                <div class="mb-3">
                                    <label for="formGroupExampleInput" class="form-label">Name</label>
                                    <input type="text" name="name" value="{{ $inventory->name }}" class="form-control" id="formGroupExampleInput" placeholder="Enter Product Name">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="brand" value="{{ $inventory->brand }}" class="form-control" id="formGroupExampleInput" placeholder="Enter Brand">
                                    @error('brand')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="category" value="{{ $inventory->category }}" class="form-control" placeholder="Enter Category">
                                    @error('category')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="quantity" value="{{ $inventory->quantity }}" class="form-control" id="priceInput" placeholder="Enter Quantity">
                                    @error('quantity')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="price" value="{{ $inventory->price }}" class="form-control" id="priceInput" placeholder="Enter Selling Price">
                                    @error('price')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select type="text" name="status" class="form-select" id="formGroupExampleInput2">
                                        <option selected disabled {{ $inventory->status == '' ? 'selected' : '' }}>Select Status</option>
                                        ...
                                        <option value="Need Restock" {{ $inventory->status == 'Need Restock' ? 'selected' : '' }}>Need Restock</option>
                                    </select>
                                    @error('status')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
